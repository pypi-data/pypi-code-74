...
class JobDefinition(models.Model):
    ...
    def get_validation_errors(self):
        ...
        if not self.title:
            errors.append("You must specify a job title.")

        if not self.endpoint or len(self.endpoint) > 200:
            errors.append("You must specify a job endpoint (up to 200 characters)")
